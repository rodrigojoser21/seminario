...
<body class="container mt-5">
    ...
    <div class="d-flex justify-content-end mb-4">
        ...
        <a href="<?php echo e(route('categorias.index')); ?>" class="btn btn-custom">Agregar Nueva Categoria</a>
    </div>
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($producto->categoria->nombreCategoria ?? 'Sin categoría'); ?></td>
                ...
                <td>
                    ...
                    <form action="<?php echo e(route('productos.destroy', $producto->id)); ?>" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this item?');">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\PruebaSemana3\resources\views/productos/index.blade.php ENDPATH**/ ?>